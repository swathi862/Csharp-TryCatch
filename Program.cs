    ...
    class Program
{
    ...
    */
    ...
    static void Main(string[] args)
    {
        ...
        newAddressBook.AddContact(bob);
        newAddressBook.AddContact(sue);
        newAddressBook.AddContact(juan);
        ...
        try{
            ...
            Console.WriteLine("That contact seems to already exist in the Address Book. Try adding a different one.");
        }
